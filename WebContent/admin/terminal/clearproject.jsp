...
function clearTerminal(){
	...
	clearprojectForm.action="/rq/clearselectedproject?cmd=CLEAR&opp=lv0029";
   ...
   <table align="center" border="0">
  	<tr>
  		...
  		<fieldset style="width:225px; height:240px;border:#6699cc 1 solid;">
							<legend align="center" style="font-size: 13px; color: #1C8EF6; font-weight: bold">终端初始化</legend>
  <table width="225" height="250" border="0" align="center" cellpadding="0"
				...
				<tr>
					<td height="30" class="tail" align="center">
						<input type="button" class="button1" onclick="clearTerminal()"
							value=" 初始化 ">
						&nbsp;
						<input type="reset" class="button1" value=" 取 消 "
							onclick="parent.closedivframe1();">
						&nbsp;&nbsp;&nbsp;&nbsp;
					</td>
				</tr>
