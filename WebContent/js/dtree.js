...
function dTree(objName) {
  ...
  if(objName=="content"){
    this.icon = {
		...
		node		: '/images/dtreeimg/device_folder_open.gif',
    ...
    this.icon = {
      root    : '/images/dtreeimg/base.gif',
      folder    : '/images/dtreeimg/schedule_folder_close.gif',
      folderOpen  : '/images/dtreeimg/schedule_folder_open.gif',
      node    : '/images/dtreeimg/schedule_schedule.gif',
      empty   : '/images/dtreeimg/empty.gif',
      line    : '/images/dtreeimg/line.gif',
      join    : '/images/dtreeimg/join.gif',
      joinBottom  : '/images/dtreeimg/joinbottom.gif',
  ...
  }else if(objName=="device" || objName=="admin_device" || objName=="device_lfd"){
    this.icon = {
      root    : '/images/dtreeimg/base.gif',
      folder    : '/images/dtreeimg/device_folder_close.gif',
      folderOpen  : '/images/dtreeimg/device_folder_open.gif',
      node    : '/images/dtreeimg/schedule_schedule.gif',
      empty   : '/images/dtreeimg/empty.gif',
      line    : '/images/dtreeimg/line.gif',
      join    : '/images/dtreeimg/join.gif',
    ...
    this.icon = {
		root		: '/images/dtreeimg/image_folder.gif',
		folder		: '/images/dtreeimg/folder.gif',
		folderOpen	: '/images/dtreeimg/folderopen.gif',
		node		: '/images/icon_content.gif',
		empty		: '/images/dtreeimg/empty.gif',
		line		: '/images/dtreeimg/line.gif',
		join		: '/images/dtreeimg/join.gif',
		joinBottom	: '/images/dtreeimg/joinbottom.gif',
