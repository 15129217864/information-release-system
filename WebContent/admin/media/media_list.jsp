...
function closedivframe(){
	...
	if(div_iframe.isclose==1){ 
		...
		if(confirm("提示信息：正在上传媒体，关闭页面将停止上传，确认关闭？")){
...
function view_media(media_title,media_type,filepath){
	...
	showDivFrame("预览媒体【"+media_title+"】","/admin/media/view_media.jsp?media_type="+media_type+"&filepath="+filepath,"800","500");
}
</script>
		<style type="text/css">
#divframe {
