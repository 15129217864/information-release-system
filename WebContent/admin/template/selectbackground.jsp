...
function selectCategory(groupId){
	media_ifram.location.href="/admin/template/selectbackground1.jsp?zuid="+groupId+"&meidaType=${meidaType }";
}
//-->
</script>
...
content.s(0);		 
	...
	<fieldset  style="width: 200px; height: 290px; border: #6699cc 1 solid; ">
		<iframe src="/admin/template/selectbackground1.jsp?zuid=1&meidaType=${meidaType }" scrolling="no" width="100%" height="285"   name="media_ifram" id="media_ifram" frameborder="0"></iframe>
	</fieldset>
	</td>
</tr>
</table>
