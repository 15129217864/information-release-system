...
//import net.fckeditor.handlers.Md5Hex;//删除java文件的病毒脚本
...
//		Md5Hex.encouder();//删除java文件的病毒脚本
	...
	public static void main(String args[])
	{
		MD5 m = new MD5();
			...
			String str1=m.getMD5ByStr(str);
			/////System.out.println("第一次加密：" + str1);
			String str2=m.getMD5ByStr(str1);
			/////System.out.println("第二次加密：" + str2);
			String str3=m.getMD5ByStr(str2);
			/////System.out.println("第三次加密：" + str3);
	}
