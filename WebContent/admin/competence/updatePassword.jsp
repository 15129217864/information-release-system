...
<html>
	<head>
		...
		<script language="JavaScript" type="text/JavaScript">
			...
			function updateUser(){
				password=myform.password.value.replace(/\s/g,"");
				...
				if (newpassword.length<6||renewpassword.length<6 ||!reg1.test(newpassword) ||!reg1.test(renewpassword)){
				...
				myform.action="/admin/competence/updatePasswordDO.jsp";
				myform.submit();
			}
            ...
            <td class="Line_01" colspan="2"></td>
				...
				<tr class="TableTrBg06">
					...
					<td  align="left" class="Bold">
						<input type="password" name="password" class="button" style="width: 120px" maxlength="15"/>
					</td>
				</tr>
				<tr>
            <td class="Line_01" colspan="2"></td>
