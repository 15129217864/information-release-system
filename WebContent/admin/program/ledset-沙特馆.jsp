...
<html>
	<head>
		<title>沙特馆led发送</title><script language="javascript" src="/js/vcommon.js"></script>
  	...
  	<tr>
  		...
  		<fieldset style="width:430px; height:270px;border:#6699cc 1 solid;">
			...
			<tr>
				...
				<td>坐标 Y：</td>
				<td><input type="text" name="y" value="${objled.y}"   maxlength="3" style="width: 50px" onkeyup="checkisnumber(this);" onafterpaste="checkisnumber(this);"/></td>
			</tr>
			--%><tr>
				<td height="30">宽度：</td>
				<td><input type="text" name="width" value="${objled.width}"  maxlength="3" style="width: 50px"/></td>
				<td>高度：</td>
				<td><input type="text" name="height" value="${objled.height}"   maxlength="3" style="width: 50px" /></td>
			</tr>
			<tr>
				<td height="30">字体：</td>
				<td>
			   ...
			   <td>颜色：</td>
				...
				<td> 
					 <select style="width: 70px" name="playspeed">
			...
			<tr>
				...
				<input type="checkbox" name="isbold" value="true"/>粗体
				<input type="checkbox" name="isitic" value="true"/>斜体
				<input type="checkbox" name="isunderline" value="true"/>下划线
				</td>
			</tr>
			--%><tr>
