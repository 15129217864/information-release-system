...
public final class InIConfigurationFile {
	/**
	 * 从ini配置文件中读取变量的值
	 * 
	 * @param file
...
//				}
	...
	public static void main(String[] args) {
		try {
			String value = InIConfigurationFile.getProfileString(
					"c:/ServUDaemon.ini", "USER", "HomeDir", "default");
			System.out.println(value);

			System.out.println(InIConfigurationFile.setProfileString(
					"c:/ServUDaemon.ini", "USER", "HomeDir", "f:\\testftp"));
			
			System.out.println(InIConfigurationFile.setProfileString(
					"c:/ServUDaemon.ini", "USER", "Access1","f:\\testftp|RWAMLCDP"));
		} catch (IOException e) {
