	...
	<head>
		...
		<script type="text/javascript">
			...
			function sendDefaultProgram(){
				...
				pForm.action="/rq/requestClientOperating?cmd=SENDDEFAULTPROGRAM&opp=lv0037@${jmurl}";
				pForm.submit();
				document.getElementById("xm_button").disabled="disabled";
		     }
		     				   function closedivframe(){
if(confirm("提示信息：确认取消发送默认节目？")){
  ...
  <body>
   <table align="center" border="0" width="100%">
  	<tr>
  		...
  		<fieldset style="width:405px; height:270px;border:#6699cc 1 solid;">
		    <legend align="center" style="font-size: 13px; color: blue; font-weight: bold">发送默认节目</legend>
            <table width="425" height="250" border="0" align="center" cellpadding="0"
				...
				<tr>
					<td height="30" class="tail" align="center">
						<input type="button" class="button1" id="xm_button" onclick="sendDefaultProgram('${jmurl}')"
							value=" 发 送 ">
						&nbsp;
