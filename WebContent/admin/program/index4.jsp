...
<html>
	...
	<FRAMESET rows="60,30,*" cols="*" border="0">
		<FRAME noresize scrolling="no" frameBorder="0"
			src="/admin/program/ter_header4.jsp?title=<%=title %>&left_menu=<%=left_menu %>&zu_id=<%=zu_id %>"
			name="deviceTop" />
		<FRAME noresize scrolling="no" frameBorder="0"
			src="/admin/program/program_list_top4.jsp" name="listtop" />
		<FRAME frameBorder="0" scrolling="auto" frameBorder="0"
			src="/admin/program/sendErrorList.jsp" 
