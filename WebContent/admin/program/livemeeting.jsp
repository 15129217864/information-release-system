  ...
  <body>
    <table width="100%" align="center" border="0" cellpadding="5" cellspacing="2" class="mb10">
        <tr>
          ...
          <td align="center" bgcolor="#D6E1ED"><strong>会议内容</strong></td>
        </tr>
        <c:choose>
         <c:when test="${not empty meetinglist}">
             <c:forEach var="meeting" items="${meetinglist}" varStatus="index">
		          <tr>
		              ...
		              <td width="14%" height="28" align="center" bgcolor="#F1F4F9">${meeting.datetimer}</td>
			          <td width="18%" height="28" align="center" bgcolor="#F1F4F9">${meeting.programaddress}</td>
			          <td width="15%" height="28" align="center" bgcolor="#F1F4F9">${meeting.programmeetingname}</td>
			          <td width="15%" height="28" align="center" bgcolor="#F1F4F9">${meeting.programmeeting eq 'no'?'':meeting.programmeeting}</td>
		        </tr>
		     </c:forEach>
         </c:when>
         <c:otherwise>
          <tr>
            <td colspan="5" height="28" align="center" bgcolor="#F1F4F9" >暂无会议预订信息</td>
          </tr>
         </c:otherwise>
        </c:choose>
