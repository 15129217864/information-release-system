...
<%
		...
		getgroupchange.getProjectXmlByUsername(username, 0, connectionfactory.getAllLinkCnt(2),"tree_"+username+"1.xml");
%>
<html>
	<head>
...
restartForm.action="/rq/requestClientOperating?cmd=STOPONDOWN&opp=lv0013";
restartForm.submit();
   ...
   <table align="center" border="0">
  	<tr>
  		...
  		<fieldset style="width:225px; height:240px;border:#6699cc 1 solid;">
							<legend align="center" style="font-size: 13px; color:#1C8EF6; font-weight: bold">停止休眠</legend>
  <table width="225" height="250" border="0" align="center" cellpadding="0"
				cellspacing="7" class="space">
				<tr>
					<td height="50px" align="center">
						<span style="color: green" >友情提示：确认停止选中终端休眠？</span>
					</td>
				</tr>
				<tr>
					<td height="30" class="tail" align="center">
						<input type="button" id="xm_button" class="button1" onclick="restartTerminal()"
							value="停止休眠">
						&nbsp;
