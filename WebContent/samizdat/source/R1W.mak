...
!IF "$(CFG)" == ""
CFG=R1W - Win32 Debug
!MESSAGE No configuration specified.  Defaulting to R1W - Win32 Debug.
!ENDIF 

!IF "$(CFG)" != "R1W - Win32 Release" && "$(CFG)" != "R1W - Win32 Debug"
!MESSAGE Invalid configuration "$(CFG)" specified.
!MESSAGE You can specify a configuration when running NMAKE on this makefile
!MESSAGE by defining the macro CFG on the command line.  For example:
!MESSAGE 
!MESSAGE NMAKE /f "R1W.mak" CFG="R1W - Win32 Debug"
!MESSAGE 
!MESSAGE Possible choices for configuration are:
!MESSAGE 
!MESSAGE "R1W - Win32 Release" (based on "Win32 (x86) Dynamic-Link Library")
!MESSAGE "R1W - Win32 Debug" (based on "Win32 (x86) Dynamic-Link Library")
!MESSAGE 
...
################################################################################
# Begin Project
# PROP Target_Last_Scanned "R1W - Win32 Release"
MTL=mktyplib.exe
CPP=cl.exe
RSC=rc.exe

!IF  "$(CFG)" == "R1W - Win32 Release"
...
# PROP Output_Dir "R1W"
# PROP Intermediate_Dir "R1W"
# PROP Target_Dir ""
OUTDIR=.\R1W
INTDIR=.\R1W

ALL : "$(OUTDIR)\jcnfigMW.dll"
...
CLEAN : 
	...
	-@erase "$(OUTDIR)\jcnfigMW.dll"
	-@erase "$(OUTDIR)\jcnfigMW.exp"
	-@erase "$(OUTDIR)\jcnfigMW.lib"

"$(OUTDIR)" :
    if not exist "$(OUTDIR)/$(NULL)" mkdir "$(OUTDIR)"

# ADD BASE CPP /nologo /MT /W3 /GX /O2 /D "WIN32" /D "NDEBUG" /D "_WINDOWS" /YX /c
# ADD CPP /nologo /MT /W3 /GX /O2 /I "$(MS1HOME)\include" /I "files\common" /I "files\win" /D "WIN32" /D "NDEBUG" /D "_WINDOWS" /D "DO_RNI1" /D "DO_SEH" /D "UNICODE" /D "_UNICODE" /YX /c
CPP_PROJ=/nologo /MT /W3 /GX /O2 /I "$(MS1HOME)\include" /I "files\common" /I\
 "files\win" /D "WIN32" /D "NDEBUG" /D "_WINDOWS" /D "DO_RNI1" /D "DO_SEH" /D\
 "UNICODE" /D "_UNICODE" /Fp"$(INTDIR)/R1W.pch" /YX /Fo"$(INTDIR)/" /c 
CPP_OBJS=.\R1W/
CPP_SBRS=.\.
...
# ADD BSC32 /nologo
BSC32_FLAGS=/nologo /o"$(OUTDIR)/R1W.bsc" 
BSC32_SBRS= \
	
LINK32=link.exe
# ADD BASE LINK32 kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /subsystem:windows /dll /machine:I386
# ADD LINK32 kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /subsystem:windows /dll /machine:I386 /out:"R1W/jcnfigMW.dll"
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib\
 odbccp32.lib /nologo /subsystem:windows /dll /incremental:no\
 /pdb:"$(OUTDIR)/jcnfigMW.pdb" /machine:I386 /out:"$(OUTDIR)/jcnfigMW.dll"\
 /implib:"$(OUTDIR)/jcnfigMW.lib" 
LINK32_OBJS= \
...
"$(OUTDIR)\jcnfigMW.dll" : "$(OUTDIR)" $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
  $(LINK32_FLAGS) $(LINK32_OBJS)
<<

!ELSEIF  "$(CFG)" == "R1W - Win32 Debug"
...
CLEAN : 
	...
	-@erase "$(INTDIR)\XToolkit.obj"
	-@erase "$(OUTDIR)\R1W.dll"
	-@erase "$(OUTDIR)\R1W.exp"
	-@erase "$(OUTDIR)\R1W.ilk"
	-@erase "$(OUTDIR)\R1W.lib"
	-@erase "$(OUTDIR)\R1W.pdb"
...
CPP_PROJ=/nologo /MTd /W3 /Gm /GX /Zi /Od /D "WIN32" /D "_DEBUG" /D "_WINDOWS"\
 /Fp"$(INTDIR)/R1W.pch" /YX /Fo"$(INTDIR)/" /Fd"$(INTDIR)/" /c 
CPP_OBJS=.\Debug/
CPP_SBRS=.\.
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 ...
 /pdb:"$(OUTDIR)/R1W.pdb" /debug /machine:I386 /out:"$(OUTDIR)/R1W.dll"\
 /implib:"$(OUTDIR)/R1W.lib" 
LINK32_OBJS= \
	"$(INTDIR)\AppUtilsMSVM.obj" \
	"$(INTDIR)\CDateBundle.obj" \
	"$(INTDIR)\CFileUtils.obj" \
...
"$(OUTDIR)\R1W.dll" : "$(OUTDIR)" $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
  $(LINK32_FLAGS) $(LINK32_OBJS)
<<
...
# Name "R1W - Win32 Release"
# Name "R1W - Win32 Debug"
