				...
				<tr>
					<td height="20px" valign="bottom" style="padding-left: 10px">
						<img src="/images/dtreeimg/${media.media_type}.gif" align="absmiddle" height="18px"
							...
							onmouseover="showimg(this,'${media.slightly_img_path}${media.slightly_img_name}')" onmouseout="hiddenimg()"  onclick="javascript:checkimg('${media.media_title}','${media.file_path}${media.file_name}')" title="${media.media_title}"/>&nbsp;<a href="javascript:;"
							onclick="javascript:checkimg('${media.media_title}','${media.file_path}${media.file_name}')">${media.media_title}</a>
					</td>
				</tr>
			</c:forEach>
		...
		<table width="80%" height="30px" align="center" border="0" style="font-size: 12px" cellspacing="0" cellpadding="0">
			<tr>
				<td align="center" valign="bottom"align="right">
                  <a href="/admin/program/selectbackground1.jsp?zuid=<%=zuid %>&meidaType=<%=meidaType %>&pagenum=1"><img src="/images/btn_first.gif" border="0"/></a>
				 <a href="/admin/program/selectbackground1.jsp?zuid=<%=zuid %>&meidaType=<%=meidaType %>&pagenum=${pager.currentPage-1 }"><img src="/images/btn_pre.gif" border="0"/></a>&nbsp;${pager.currentPage }
                  <a href="/admin/program/selectbackground1.jsp?zuid=<%=zuid %>&meidaType=<%=meidaType %>&pagenum=${pager.currentPage+1 }"><img src="/images/btn_next.gif" border="0"/></a>
                  <a href="/admin/program/selectbackground1.jsp?zuid=<%=zuid %>&meidaType=<%=meidaType %>&pagenum=${pager.end }"><img src="/images/btn_end.gif" border="0"/></a>
                  ¹²${pager.totalPage }Ò³ 
				</td>
			</tr>
		</table>
