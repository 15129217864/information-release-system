...
<html>
	...
	<FRAMESET rows="60,30,*" cols="*" border="0">
		<FRAME noresize scrolling="no" frameBorder="0"
			src="/admin/program/ter_header2.jsp?title=<%=title %>&left_menu=<%=left_menu %>&zu_id=<%=zu_id %>"
			name="deviceTop" />
		<FRAME noresize scrolling="no" frameBorder="0"
			src="/admin/program/program_list_top3.jsp?left_menu=<%=left_menu %>" name="listtop" />
		<FRAME frameBorder="0" scrolling="auto" frameBorder="0"
			src="/admin/program/auditprogramList.jsp?left_menu=<%=left_menu %>" 
