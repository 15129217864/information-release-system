...
<html>
	<head>
		...
		<script language="JavaScript">
			parent.menu.location.href="/admin/competence/left.jsp";	
			</script>
		<%} %>
	...
	<FRAMESET rows="63,30,*" cols="*" border="0">
		<FRAME noresize scrolling="no" frameBorder="0"
			src="/admin/competence/ter_header.jsp?title=<%=title %>&left_menu=<%=left_menu %>"
			name="deviceTop" />
		<FRAME noresize scrolling="no" frameBorder="0"
			src="/admin/competence/competence_list_top.jsp" name="listtop" />
		<FRAME frameBorder="0" scrolling="auto" frameBorder="0"
			src="/admin/competence/userList.jsp?left_menu=<%=left_menu %>"
