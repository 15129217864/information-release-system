...
if(template==null){out.println("<span style='color:red'>暂无模板，请添加模板！</span>");}
...
document.getElementById("fathermodel").appendChild(newPreview);
	...
	<body style="margin:5px ;  font-size:12px;">
		...
		<c:forEach var="module" items="${moduleList}">
			<script type="text/javascript">
				addUpload(${(module.m_left-2)*scale},${(module.m_top-2)*scale},${module.m_width*scale},${module.m_height*scale+2});
			</script>
		</c:forEach>
	</body>
</html>
