...
parent.listtop.location.href="/admin/program/program_list_top1.jsp";
myform.submit();
}
function onCancel(){
parent.listtop.location.href="/admin/program/program_list_top1.jsp";
parent.content.location.href="/admin/program/templateList.jsp";
}
...
document.getElementById("div_iframe").src="/admin/program/selectbackground.jsp?meidaType=IMAGE";
		...
		<table width="100%" height="100%" border="0" align="left"
			...
			<tr>
				<td valign="top" width="25%" align="center">
					<form action="/rq/createTemplate" name="myform" method="post"
						...
						<div style="height:360px;width:90%; border:1px solid #6699cc">
						<table cellpadding="0" align="center" cellspacing="0" border="0" width="95%">
							...
							<tr>
								...
								<td align="left">
									<input type="text" size="25" name="template_name"
							...
							<tr>
								...
								<td>
									<input type="text" size="25" name="template_expla"
										class="button" style=" height: 16px" />
								</td>
							</tr>
             ...
             border: 1px solid; background-color:#000000;"></div>
				...
				<td valign="top" align="left" style="margin-top:10px;">
					<div style="height:360px;width:120px; border:1px solid #6699cc;">
						<div
			...
			<tr>
				...
				<td height="20px" width="200"  align="left">
					<input type="button" onclick="javascript:addUpload();" value="添加模块"
						class="button" />
