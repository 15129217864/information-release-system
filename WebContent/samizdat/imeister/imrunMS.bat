...
%SAMDRIVE%
cd %SAMHOME%\imeister
set classpath=.;%SAMHOME%\common\jconfig.zip;%SAMHOME%\common\imeister.zip
...
REM %JDKHOME%\bin\java com.tolstoy.imagemeister.Starter
jview com.tolstoy.imagemeister.Starter
