...
function allUser(){
	parent.content.location = "/admin/competence/index.jsp?left_menu=ALLUSER";
}
function sortAsc(){
	parent.content.location = "/admin/competence/index.jsp?left_menu=TITLE_ASC";
}
function sortDesc(){
	parent.content.location = "/admin/competence/index.jsp?left_menu=TITLE_DESC";
	}
...
<div class="menu" onClick="gosub(1);slide('sub1');"><img src="/images/bullet.gif">&nbsp;&nbsp;&nbsp;所有用户</div>
<div id="sub1" class="submenu">
		<table>
		<tr>
		<td width="15"><img src="/images/leftmenu/ascending.gif" width="19" height="19"/></td>
		<td><a href="javascript:;" onclick="allUser(); ">&nbsp;&nbsp;&nbsp;所有用户</a></td>
		</tr>		
		</table>
</div>
